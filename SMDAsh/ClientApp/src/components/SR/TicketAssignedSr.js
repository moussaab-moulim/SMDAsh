...
import {
    getTicketAssignedOcpSr,
    getTicketAssignedRunServiceSr,
} from '../../redux/actions/SR/TicketAssignedSrAction';
...
export default function TicketAssignedSr() {
    ...
    const chartTicketAssignedOcpState = useSelector((state) => state.ticketAssignedOcpSr, []) || [];
    const chartTicketAssignedRunServiceState = useSelector((state) => state.ticketAssignedRunServiceSr, []) || [];
    ...
    useEffect(() => {
        ...
        if (chartTicketAssignedOcpState.loading || reloardData) {
            ...
            dispatch(getTicketAssignedOcpSr());
            dispatch(getTicketAssignedRunServiceSr());
            setReloadData(false);
