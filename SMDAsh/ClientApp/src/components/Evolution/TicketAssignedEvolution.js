...
import {
    getTicketAssignedOcpEvolution, getTicketAssignedRunServiceEvolution
} from '../../redux/actions/Evolution/TicketAssignedEvolutionAction';
...
export default function TicketAssignedEvolution() {
    ...
    const chartTicketAssignedOcpState = useSelector((state) => state.ticketAssignedOcpEvolution, []) || [];
    const chartTicketAssignedRunServiceState = useSelector((state) => state.ticketAssignedRunServiceEvolution, []) || [];
    ...
    useEffect(() => {
        ...
        if (chartTicketAssignedOcpState.loading || reloardData) {
            ...
            dispatch(getTicketAssignedOcpEvolution());
            dispatch(getTicketAssignedRunServiceEvolution());
            setReloadData(false);
